...
class AdvancedClient extends Discord.Client {
    constructor(ayarlar) {
      super(ayarlar);
        ...
        if (c !== undefined || c) {
            for (var i = 0; i < cmd.args.length; i++) {
                ...
                if (cxc[i+1] === undefined) {
                    msg.channel.send(new Discord.RichEmbed().setColor("DARKBLUE").setDescription(cmd.args[i].soru).setFooter("Komut işlemini iptal etmek için \"iptal\" yazınız. \nKomut işlemi otomatik olarak \"30\" saniye sonra iptal edilecektir."))
